...
/*********************************************************************************
	...
	* Preconditions:	NIL
	*
	* Postconditions:	Program has exited with code 89
	*********************************************************************************/
	void Calculator::displayError( char* errorMessage )								//- Prints out a custom error message depending on the case and terminates the program
	{
		...
		//- Left Empty
	#endif																						
		exit( 89 );												//- Setting a custom exit number, so we know the program exited due to our error handling
	}
	...
	*			exiting the program with code 89.
	*
