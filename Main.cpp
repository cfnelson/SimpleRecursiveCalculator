...
int main (void)
{
	bool quitCalculator = false;																							//- Ensure that the calculator is always running. Bool is never set to true, loop only ends when an error occurs or user selects q || Q.
